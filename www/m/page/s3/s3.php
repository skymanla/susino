...
<div class="wrap_store_style compact">
	<div class="store_intro">컴팩트 매장</div>
	<div class="s_tit"><img src="/m/img/s3/s3s3_sub_tit1.png" alt="컴팩트 컨셉" /></div>
	<div class="s_d_cont">
		<h3 class="d_cont_tit">심플하고 가벼운 당신, 컴팩트 컨셉. 혼자여도 부담없는 공간을 위해 다찌의 활용을 극대화 시켰으며,
		매장에 방문하시는 고객들과 쉐프와의 거리를 줄였습니다.</h3>
		<div class="series_wrap">
			<div class="swiper-container slide-wrap s_con">
				<ul class="swiper-wrapper slide">
					<li class="swiper-slide">
						<div class="roll_img">
							<img src="/m/img/s3/03_01_rolling.jpg" alt="" />
						</div>
					</li>
					<li class="swiper-slide">
						<div class="roll_img">
							<img src="/m/img/s3/03_02_rolling.jpg" alt="" />
						</div>
					</li>
				</ul>
	...
	<div class="s_tit"><img src="/m/img/s3/s3s3_sub_tit2.png" alt="컴팩트 메뉴" /></div>
	<div class="s_d_cont2">
		<h3 class="d_cont_tit">심플하고 가벼운 당신, 컴팩트 컨셉. 혼자여도 부담없는 공간을 위해 다찌의 활용을 극대화 시켰으며,
		매장에 방문하시는 고객들과 쉐프와의 거리를 줄였습니다.</h3>
		<div>
			<ul class="ban_style">
				<li><a href="/m/page/s2/s6s1.php"><img src="/m/img/s3/03_01_ban1.jpg" alt="백쉐프 초밥" /></a></li>
				<li><a href="/m/page/s2/s6s2.php"><img src="/m/img/s3/03_01_ban2.jpg" alt="모듬 초밥" /></a></li>
				<li><a href="/m/page/s2/s6s3.php"><img src="/m/img/s3/03_01_ban3.jpg" alt="오늘의 초밥" /></a></li>
				<li><a href="/m/page/s2/s6s4.php"><img src="/m/img/s3/03_01_ban4.jpg" alt="테마키스시" /></a></li>
				<li><a href="/m/page/s2/s6s5.php"><img src="/m/img/s3/03_01_ban5.jpg" alt="간편스시" /></a></li>
				<li><a href="/m/page/s2/s6s6.php"><img src="/m/img/s3/03_01_ban6.jpg" alt="컴팩트 사시미" /></a></li>
			</ul>
			<!-- <div class="bt_wrap_center"> -->
				<!-- <button type="button" class="bt_2s_c_tranparent">컴팩트 매장 찾기</button> -->
			<!-- </div> -->
		</div>
	...
	<div class="map_search_wrap">
		<div class="data_form">
			<ul class="radio_box jquery_checked" style="display:none;">
				...
				<li><input type="radio" class="" value="2" name="s_info_type" id="s_info_type_check3" checked /><label for="s_info_type_check3">컴팩트</label></li>
