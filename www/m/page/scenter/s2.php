	...
	<div class="wrap_register_form">
		...
		<div class="bg_box">
			...
			<div class="in_form">
				...
				<input type="text" id="form_lbl_20" value="" name="" />
				<h5><label for="form_lbl_21">연락처</label></h5>
				<ul class="f_table">
					<li>
						<select name="" id="form_lbl_21">
				...
				<ul class="f_table">
					<li><input type="text" id="form_lbl_22" value="" name="" /></li>
				...
				<input type="text" id="form_lbl_23" value="" name="" />
				<h5><label for="form_lbl_24">문의내용</label></h5>
				<textarea name="" id="form_lbl_24" cols="30" rows="10"></textarea>
				<h5><label for="form_lbl_25">파일첨부</label></h5>
				<input type="file" id="form_lbl_25" value="" name="">
			</div>
			<!-- END </form> -->
		</div>
	</div>
