...
<form name="reviewForm" id="reviewForm" method="post" enctype="multipart/form-data">
	...
	<div class="wrap_conts wid_full step1">
		...
		<div class="wrap_caution">
			<h3>후기 전송 시 알아두세요</h3>
			<ul>
				<li>방문 후기 글을 등록한 URL을 아래에 공유해 주시면 관리자가 확인 후 우동맛 스티커가 적용됩니다.</li>
		...
		<div class="wrap_register_form">
			...
			<div class="bg_box">
				<div class="in_form">
					...
					<h5><label for="form_lbl_13">블로그의 방문 후기 글 URL을 알려주세요.</label></h5>
		...
		<div class="wrap_register_form">
			...
			<div class="bg_box">
				<div class="in_form">
					...
					<h5>메뉴사진</h5>
					<ul class="f_table">
						<li><input type="file" id="form_lbl_20" value="" name="file1" accept="image/*"></li>
						<li><button type="button" class="bt_2s_c_gray"><label for="form_lbl_20">파일첨부</label></button></li>
					</ul>
					<h5>영수증 첨부</h5>
					<ul class="f_table">
						<li><input type="file" id="form_lbl_14" value="" name="file2" accept="image/*"></li>
