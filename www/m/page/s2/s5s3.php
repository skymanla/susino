	...
	<div class="wrap_in_ssi">
		<div class="img_select">
			...
			<select id="ssi_select_list" name="" title="" onchange="location = this.value;">
				...
				<option value="/m/page/s2/s5s3.php" selected="selected">런치 스시</option>
		...
		<div class="img_change">
			<img src="/m/img/s2/04_03_01.jpg" alt="" />
			<div class="ssi_guide">
				<p>다이닝 매장에서 점심시간(11:00~13:30)에만 만나보실 수 있는 런치 초밥 모둠 메뉴입니다.</p>
				<div>신선 샐러드 + 신선 초밥 10pcs
				(활어, 연어, 가리비, 메카대절, 아카미, 초쭈꾸미, 한치, 초새우, 백미새우, 다마고) + 우동 후식
				(나가사끼 생우동 or 생생 어묵우동 or 냉모밀(계절 메뉴) 중 택)
				</div>
				<span>1인 <strong>10,000원</strong></span>
			</div>
		</div>
		<div class="ssi_guide_sec">
			<img src="/m/img/s2/04_03_02.jpg" alt="" />
			<p>
			스시노백쉐프 다이닝 매장에서 런치 타임(11:00~13:30)에만 제공되는
			런치 모둠 스시, 런치 스시
			오늘 점심은 초밥! 어때요?
			</p>
		</div>
