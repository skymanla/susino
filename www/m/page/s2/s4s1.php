	...
	<div class="wrap_in_ssi">
		<div class="img_select">
			...
			<select id="ssi_select_list" name="" title="" onchange="location = this.value;">
				<option value="/m/page/s2/s4s1.php" selected="selected">백쉐프 초밥</option>
				...
				<option value="/m/page/s2/s4s5.php">간편 스시</option>
				<option value="/m/page/s2/s4s6.php">컴팩트 사시미</option>
			</select>
		</div>
		<div class="img_change">
			<img src="/m/img/s2/05_01_01.jpg" alt="" />
			<div class="ssi_guide">
				<p>스시노백쉐프의 마스터쉐프, 백승성 쉐프가 추천하는 컴팩트 매장 전용 프리미엄 1인 초밥 메뉴입니다. </p>
				<div>구성 : 신선 샐러드 + 신선 초밥 (계절생선(활어), 오도로, 아까미, 메카도로, 전복, 와규불초밥, 육회초밥, 장새우, 장어½, 게내장군함) + 나가사끼 생우동 or 냉모밀 (5~9월) + 디저트
				</div>
				<span>1인 <strong>19,900원</strong></span>
			</div>
		</div>
