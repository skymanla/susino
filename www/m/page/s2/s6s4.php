	...
	<div class="wrap_in_ssi">
		<div class="img_select">
			...
			<select id="ssi_select_list" name="" title="" onchange="location = this.value;">
				...
				<option value="/m/page/s2/s6s4.php" selected="selected">테마키스시</option>
				<option value="/m/page/s2/s6s5.php">간편 스시</option>
				<option value="/m/page/s2/s6s6.php">컴팩트 사시미</option>
			</select>
		</div>
		<div class="img_change">
			<img src="/m/img/s2/05_04_01.jpg" alt="" />
			<div class="ssi_guide">
				<p>다시마 위에 샤리와 재료를 얹고 손으로 싸먹는 초밥으로, 100여년전 일본에서 등장한 가정 특화형 초밥 중 하나입니다.  </p>
				<div>구성 : 신선 샐러드 + 테마키스시 (계절생선(활어), 생새우, 장새우, 가이바시, 생연어, 아까미, 메카대절, 육회사시미) + 샤리(초밥 밥)
				</div>
				<span>1인 <strong>30,000원</strong></span>
			</div>
		</div>
