	...
	<div class="wrap_in_ssi">
		<div class="img_select">
			...
			<select id="ssi_select_list" name="" title="" onchange="location = this.value;">
				...
				<option value="/m/page/s2/s6s6.php" selected="selected">컴팩트 사시미</option>
			</select>
		</div>
		<div class="img_change">
			<img src="/m/img/s2/05_06_01.jpg" alt="" />
			<div class="ssi_guide">
				<p>활어, 연어, 참치 모듬 사시미를 육회와 함께 심플하게 즐길 수 있는 컴팩트 매장 전용 사시미 메뉴 입니다. </p>
				<div>구성 : 활어 사시미 12pcs / 연어 사시미 12pcs / 참치 사시미(아까미, 메카대절) 12pcs / 모듬 사시미(활어, 연어, 아까미, 메카대절) 12pcs + 육회사시미
				</div>
				<span>12pcs + 육회사시미 <strong>20,000원 ~ 25,000원</strong></span>
			</div>
		</div>
