	...
	<div class="wrap_in_ssi">
		<div class="img_select">
			...
			<select id="ssi_select_list" name="" title="" onchange="location = this.value;">
				<option value="/m/page/s2/s7s1.php">특사시미 라인</option>
				<option value="/m/page/s2/s7s2.php">사시미 라인</option>
				<option value="/m/page/s2/s7s3.php">스시노 알탕</option>
				<option value="/m/page/s2/s7s4.php" selected="selected">맑은 어묵탕</option>
			</select>
		</div>
		<div class="img_change">
			<img src="/m/img/s2/06_04_01.jpg" alt="" />
			<div class="ssi_guide">
				<p>어묵으로 시원한 국물을 낸 맑은어묵탕</p>
				<!-- <div>
				</div> -->
				<span> <strong>12,000원</strong></span>
			</div>
		</div>
