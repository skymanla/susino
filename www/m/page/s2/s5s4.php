	...
	<div class="wrap_in_ssi">
		<div class="img_select">
			...
			<select id="ssi_select_list" name="" title="" onchange="location = this.value;">
				...
				<option value="/m/page/s2/s5s4.php" selected="selected">아나고동</option>
		...
		<div class="img_change">
			<img src="/m/img/s2/04_04_01.jpg" alt="" />
			<div class="ssi_guide">
				<p>스시노백쉐프의 특별한 장어를 제대로 즐길 수 있는 런치 메뉴</p>
				<!-- <div>
				</div> -->
				<span>1인 <strong>11,000원</strong></span>
			</div>
		</div>
