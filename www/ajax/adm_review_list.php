...
if($eType == "waiting" || $eType == ""){
	include_once($_SERVER['DOCUMENT_ROOT']."/ajax/review/adm_review_waiting.php");
}else if($eType == "accept"){
	include_once($_SERVER['DOCUMENT_ROOT']."/ajax/review/adm_review_accept.php");
}else if($eType == "refuse"){
	include_once($_SERVER['DOCUMENT_ROOT']."/ajax/review/adm_review_refuse.php");
}
?>
