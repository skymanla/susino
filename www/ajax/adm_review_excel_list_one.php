...
?>
<ul class="tab_type1">
	<li><a href="javascript:move_page('shopper');">미스터리 쇼퍼</a></li>
	<li><a href="javascript:move_page('ftalk');">스시노 미식회</a></li>
	<li><a href="javascript:move_page('pick');">체험단</a></li>
	<li><a href="javascript:move_page('selfer');">자발적 참여자</a></li>
	<li class="active"><a href="javascript:move_page('once');">최초1회 참여자</a></li>
