...
if($eType == "waiting" || $eType == ""){
	include_once($_SERVER['DOCUMENT_ROOT']."/ajax/review/adm_review_selfer_waiting.php");
}else if($eType == "accept"){
	include_once($_SERVER['DOCUMENT_ROOT']."/ajax/review/adm_review_selfer_accept.php");
}else if($eType == "refuse"){
	include_once($_SERVER['DOCUMENT_ROOT']."/ajax/review/adm_review_selfer_refuse.php");
}
?>
