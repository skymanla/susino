...
<section class="section1">
	...
	<h3>체험단 신청자</h3>
	<ul class="tab_type1">
		<li><a href="s4sview.php">신청자 목록</a></li>
		<li class="active"><a href="s4sview_list1.php">당첨자</a></li>
		<li><a href="s4sview_list2.php">당첨자 직접 등록</a></li>
	</ul>
	...
	<div class="bt_wrap1">
		...
		<div class="right_box">
			<a href="s4ssmswrite.php" class="bt_1">당첨자 sms 발송</a>
			<a href="s4semailwrite.php" class="bt_1">당첨자 E-mail 발송</a>
		</div>
	</div>
