...
<section class="section1">
	...
	<form name="myform1" id="myform1" method="post" enctype="multipart/form-data" onsubmit="write_ok(this);">
		...
		<input type="hidden" name="flag_depth1" id="flag_depth1" value="ftalk" />
		<input type="hidden" name="mode" id="mode" value="<?=$mode?>" />
		<input type="hidden" name="idx" id="idx" value="<?=$_GET['idx']?>" />
		<div class="table_wrap1">
			<table>
				<caption>스시노 미식회 작성</caption>
				<colgroup>
					<col width="150">
					<col width="">
				</colgroup>
				<thead>
					<tr>
						<th colspan="4" class="txt_l">스시노 미식회 작성</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td>
							<select name="s_sido" id="s_sido" title="" class="w_input1" onchange="findArea(this)">
								<option value="A" data-real-addr="all" selected >전체</option>
