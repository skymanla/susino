...
<section class="section1">
	...
	<h3>스시노 미식회 신청자</h3>
	<ul class="tab_type1">
		<li><a href="s3sview.php">신청자 목록</a></li>
		<li class="active"><a href="s3sview_list1.php">당첨자</a></li>
		<li><a href="s3sview_list2.php">당첨자 직접 등록</a></li>
	</ul>
	...
	<div class="bt_wrap1">
		...
		<div class="right_box">
			<a href="s3ssmswrite.php" class="bt_1">당첨자 sms 발송</a>
			<a href="s3semailwrite.php" class="bt_1">당첨자 E-mail 발송</a>
		</div>
	</div>
	...
	<div class="table_wrap1">
		<table>
			...
			<tbody>
				...
				<tr>
					<th>제목</th>
					<td>유니크매장 스시노 미식회를 모집합니다!</td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						유니크매장 스시노 미식회를 모집합니다! <br />
						유니크매장 스시노 미식회를 모집합니다! <br />
						유니크매장 스시노 미식회를 모집합니다! <br />
						유니크매장 스시노 미식회를 모집합니다! <br />
						유니크매장 스시노 미식회를 모집합니다! <br />
	...
	<div class="bt_wrap2">
		<a href="s3swrite.php" class="bt_1">수정하기</a>
