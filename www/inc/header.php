<header id="header">
	<div class="head_top">
		...
		<div class="blank_wrap">
			<a href="https://winddesign33.cafe24.com" target="_blank" title="새창으로 열립니다."><img src="/img/nav/t_nav2_1.gif" alt="일성코퍼레이션" /></a>
		...
		<div class="g_nav">
			...
			<a href="/ownerchef" target="_blank" title="새창으로 열립니다."><img src="/img/nav/t_nav1_3.gif" alt="멋진 쉐프 상시모집" /></a>
		</div>
		<?php if(!$w_index) {?>
	...
	<ul class="gnb">
		<li <?php if($w_a_num===0){?>class="active"<?php }?>>
			<a href="/page/s1/s1.php"><i></i><img src="/img/nav/gnb1.png" alt="어울림 스시노백쉐프" /></a>
			<ul class="s1">
		...
		<li <?php if($w_a_num===1){?>class="active"<?php }?>>
			<a href="/page/s2/s7.php"><i></i><img src="/img/nav/gnb2.png" alt="초밥" /></a>
			<ul class="s2">
		...
		<li <?php if($w_a_num===2){?>class="active"<?php }?>>
			<a href="/page/s3/s1.php"><i></i><img src="/img/nav/gnb3.png" alt="초밥집" /></a>
			<ul class="s3">
		...
		<li <?php if($w_a_num===3){?>class="active"<?php }?>>
			<a href="/page/s4/s2.php"><i></i><img src="/img/nav/gnb4.png" alt="배달 초밥" /></a>
			<ul class="s4">
		...
		<li <?php if($w_a_num===4){?>class="active"<?php }?>>
			<a href="/page/s5/s3.php"><i></i><img src="/img/nav/gnb5.png" alt="단골고객/우동맛" /></a>
			<ul class="s5">
		...
		<li <?php if($w_a_num===5){?>class="active"<?php }?>>
			<a href="/page/s6/s2.php"><i></i><img src="/img/nav/gnb6.png" alt="이벤트" /></a>
			<ul class="s6">
