	...
	<div class="con_wrapStyle1">
		...
		<div class="bt_LR_wrap">
			...
			<div class="f_left">
				...
				?>
				<a href="./s2sview.php?idx=<?php echo $sbn_idx?>"><button type="button" class="bt_s3_bdrGray left">이전글</button></a>
				<?php
				}
				?>
				<?php
				...
				?>
				<a href="./s2sview.php?idx=<?php echo $sbn_idx?>"><button type="button" class="bt_s3_bdrGray right">다음글</button></a>
				<?php
				}
				?>
			</div>
