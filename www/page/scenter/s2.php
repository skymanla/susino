...
<div class="wrap_style1">
	...
	<div class="con_wrapStyle1">
		...
		?>
		<div class="admin_bt">
			<a href="/page/scenter/s2swrite.php?mode=w" class="w_edit">글쓰기</a>
		</div>
		<?php
		}
		?>
		<table class="board_style2">
			...
			<tbody>
				...
				<tr>
					...
					<td class="left"><a href="/page/scenter/s2sview.php?idx=<?php echo $row['sbn_idx'];?>"><?php echo $row['sbn_title'];?></a></td>
