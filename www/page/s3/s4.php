...
<div class="s3_wrap1 s3s4">
	<div class="section_top">
		<div class="bt_wrap">
			<div class="s1"><a href="#box1"><i>특별한 강남 스타일</i></a></div>
			<div class="s2"><a href="#box2"><i>특별한 메뉴</i></a></div>
			<div class="s3"><a href="#box3"><i>오시는 길</i></a></div>
		</div>
	</div>
	...
	<div class="section2" id="box2">
		<div class="bt_wrap">
			<div>
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop1.jpg');">
					<img src="/img/s3/s3s4_image1.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle1.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop1.jpg');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div>
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop2.jpg');">
					<img src="/img/s3/s3s4_image2.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle2.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop2.jpg');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div>
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop3.jpg','150px');">
					<img src="/img/s3/s3s4_image3.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle3.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop3.jpg','150px');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div>
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop4.jpg','150px');">
					<img src="/img/s3/s3s4_image4.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle4.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop4.jpg','150px');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div class="h1">
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop5.jpg','250px');">
					<img src="/img/s3/s3s4_image5.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle5.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop5.jpg','250px');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div class="mart1 s1">
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop6.jpg','290px');">
					<img src="/img/s3/s3s4_image6.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle6.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop6.jpg','290px');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div class="mart1 s2">
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop7.jpg','290px');">
					<img src="/img/s3/s3s4_image7.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle7.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop7.jpg','290px');">자세히 보기</a>
					</div>
				</div>
			</div>
			<div class="mart1 s3">
				<div onclick="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop8.jpg','290px');">
					<img src="/img/s3/s3s4_image8.jpg" alt="" />
					<div class="copy">
						<p class="title"><img src="/img/s3/s3s4_tittle8.png" alt="" /></p>
						<a href="javascript:popOpenAc1('#pop_ac1','/img/s3/s3s4_pop8.jpg','290px');">자세히 보기</a>
					</div>
				</div>
			</div>
		</div>
		<div class="pop_wrap" id="pop_ac1">
			<div>
				<button type="button" class="pop_close" onClick="popCloseAc1('#pop_ac1');" ><i>닫기</i></button>
				<img src="/img/s3/s3s4_pop1.jpg" alt="" />
			</div>
		</div>
	</div>
			...
			<div class="left_box" style="display:none">
				...
				<div class="data_form">
					<div class="radio_box" style="display:none">
						...
						<div><input type="radio" class="" value="1" name="s_info_type" id="s_info_type_check2"  /><label for="s_info_type_check2">다이닝</label></div>
						<div><input type="radio" class="" value="2" name="s_info_type" id="s_info_type_check3"  /><label for="s_info_type_check3">컴팩트</label></div>
						<div><input type="radio" class="" value="3" name="s_info_type" id="s_info_type_check4" checked /><label for="s_info_type_check4">강남★스타</label></div>
					</div>
