...
<div class="wrap_style1">
	...
	<div class="map_search_wrap">
		<div class="left_box">
			...
			<div class="data_form">
				<div class="radio_box jquery_checked">
					<div class="all"><input type="radio" class="" value="" name="s_info_type" id="s_info_type_check1" checked /><label for="s_info_type_check1"><i></i>전체매장</label></div>
					<div><input type="radio" class="" value="1" name="s_info_type" id="s_info_type_check2" /><label for="s_info_type_check2"><i></i>다이닝</label></div>
					<div><input type="radio" class="" value="2" name="s_info_type" id="s_info_type_check3" /><label for="s_info_type_check3"><i></i>컴팩트</label></div>
					<div><input type="radio" class="" value="3" name="s_info_type" id="s_info_type_check4" /><label for="s_info_type_check4"><i></i>유니크</label></div>
				</div>
			...
			<ul class="roll">
				...
				<li>
					<div>
						...
						<div class="info_call"><?php echo $row['sbs_tel'];?></div>
						<div class="info_type bg<?php echo $row['sbs_type'];?>"><i><?php echo $row['sbs_type'];?></i></div>
						<button type="button" class="go_map">지도보기</button>
						<?php if($_GET['adm']){?>
						<a href="/page/s3/s1swrite.php" class="pin_modify">수정하기</a>
						<?php }?>
					</div>
				</li>
				<?php }?>
