...
<div class="s3_wrap1 s3s3">
	<div class="section_top">
		<div class="bt_wrap">
			<div class="s1"><a href="#box1"><i>컴팩트 컨셉</i></a></div>
			<div class="s2"><a href="#box2"><i>컴팩트 메뉴</i></a></div>
	...
	<div class="section1" id="box1">
		<div class="slider_wrap">
			<div class="series1 active">
				<ul class="roll">
					<li><img src="/img/s3/s3s3_s_img11.jpg" alt="" /></li>
					<li><img src="/img/s3/s3s3_s_img12.jpg" alt="" /></li>
					<li><img src="/img/s3/s3s3_s_img13.jpg" alt="" /></li>
					<li><img src="/img/s3/s3s3_s_img14.jpg" alt="" /></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="section2" id="box2">
		<div class="con_wrap_s2">
			<ul class="ban_style_s2">
				<li>
					<div class="in_style" onclick="location.href='/page/s2/s4s1.php'">
						<img src="/img/s2/s2s4_image1.jpg" alt="">
						<div class="tit_box"><h3 class="type2 tit_s2s4_1"></h3></div>
						<div class="hover_view">
							<div class="center_link">
								<div class="in">
									<h3 class="hover type2 tit_s2s4_1"></h3>
									<a href="/page/s2/s4s1.php" class="bt_more">자세히보기</a>
								</div>
							</div>
						</div>
					</div>
				...
				<li>
					<div class="in_style" onclick="location.href='/page/s2/s4s2.php'">
						<img src="/img/s2/s2s4_image2.jpg" alt="">
						<div class="tit_box"><h3 class="type2 tit_s2s4_2"></h3></div>
						<div class="hover_view">
							<div class="center_link">
								<div class="in">
									<h3 class="hover type2 tit_s2s4_2"></h3>
									<a href="/page/s2/s4s2.php" class="bt_more">자세히보기</a>
								</div>
							</div>
						</div>
					</div>
				...
				<li>
					<div class="in_style" onclick="location.href='/page/s2/s4s3.php'">
						<img src="/img/s2/s2s4_image3.jpg" alt="">
						<div class="tit_box"><h3 class="type2 tit_s2s4_3"></h3></div>
						<div class="hover_view">
							<div class="center_link">
								<div class="in">
									<h3 class="hover type2 tit_s2s4_3"></h3>
									<a href="/page/s2/s4s3.php" class="bt_more">자세히보기</a>
								</div>
							</div>
						</div>
					</div>
				...
				<li>
					<div class="in_style" onclick="location.href='/page/s2/s4s4.php'">
						<img src="/img/s2/s2s4_image4.jpg" alt="">
						<div class="tit_box"><h3 class="type2 tit_s2s4_4"></h3></div>
						<div class="hover_view">
							<div class="center_link">
								<div class="in">
									<h3 class="hover type2 tit_s2s4_4"></h3>
									<a href="/page/s2/s4s4.php" class="bt_more">자세히보기</a>
								</div>
							</div>
						</div>
					</div>
				...
				<li>
					<div class="in_style" onclick="location.href='/page/s2/s4s5.php'">
						<img src="/img/s2/s2s4_image5.jpg" alt="">
						<div class="tit_box"><h3 class="type2 tit_s2s4_5"></h3></div>
						<div class="hover_view">
							<div class="center_link">
								<div class="in">
									<h3 class="hover type2 tit_s2s4_5"></h3>
									<a href="/page/s2/s4s5.php" class="bt_more">자세히보기</a>
								</div>
							</div>
						</div>
					</div>
				...
				<li>
					<div class="in_style" onclick="location.href='/page/s2/s4s6.php'">
						<img src="/img/s2/s2s4_image6.jpg" alt="">
						<div class="tit_box"><h3 class="type2 tit_s2s4_6"></h3></div>
						<div class="hover_view">
							<div class="center_link">
								<div class="in">
									<h3 class="hover type2 tit_s2s4_6"></h3>
									<a href="/page/s2/s4s6.php" class="bt_more">자세히보기</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="left_box">
				...
				<div class="data_form">
					<div class="radio_box" style="display:none">
						...
						<div><input type="radio" class="" value="2" name="s_info_type" id="s_info_type_check3" checked /><label for="s_info_type_check3">컴팩트</label></div>
