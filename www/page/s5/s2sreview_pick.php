...
<div class="wrap_style1">
	<div class="heading_s1">
		<h2 class="tit"><img src="/img/common/review_title_pick.png" alt="체험단 후기작성"></h2>
	</div>
	<div class="review_form">
		<div class="review_section fr">
			<div class="info_wrap2">
				방문 후기 글을 등록한 URL을 아래에 공유해 주시면 관리자가 확인 후 우동맛 스티커가 적용됩니다.<br />
				<br />
				...
				<br />
				평가사항은 더 좋은 초밥을 만들기 위해 운영되는 정책으로 보다 나은 서비스와 맛을 위해 아낌없는 충언과 의견을 기다리고 있습니다. 감사합니다.
			</div>
		</div>
						...
						<tbody>
							<tr>
								<td>
									...
									<input type="text" class="setdate" value="" name="" placeholder="" style="width:40%;"  readonly/>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									<div class="title1">블로그의 방문 후기 글 URL을 알려주세요.</div>
